...
if __name__ == '__main__':
    ...
    log_file = '/share/nas1/liuw/sql_files_mbd/logs_insert_taxonomy_json/'+user_name+'_'+project_type+'.log'
    ...
    for p in web_report_dic.keys():
        for k in project_list.keys():
            if project_dict[p] == k:
                ...
                os.system('python /share/nas1/liuheng/02.develop/55.add_NeedData_file/add_config_file.py -p %s' % root_path_parent)
                file_not_in_db_then_push(cursor1, root_path_parent+'/Needed_Data/taxonomy.json', needed_data_uuid, user_uuid, user_name, project_type, db_dir, run_mode)
