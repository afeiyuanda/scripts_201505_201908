...
if __name__ == '__main__':
    ...
    newParser.add_argument( '-app', dest='project_type', help='project_type:ref', default='reseq' );
    ...
    for p in web_report_dic.keys():
        for k in project_list.keys():
            if project_dict[p] == k:
                ...
                # 针对reseq进行处理
                # python /share/nas2/genome/cloud_soft/developer_platform/resequencing_pipeline/v3.0/main_pipeline/metadata_properties_reseq.py -prt /share/nas1/liuheng/test_dir/meta_analysis/Web_Report/
                if project_type == 'reseq':
                    #生成metadata.properties
                    new_init_script = '/share/nas2/genome/cloud_soft/developer_platform/resequencing_pipeline/v3.0/main_pipeline/metadata_properties_reseq.py'
